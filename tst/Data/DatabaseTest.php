...
class DatabaseTest extends TestCase
{
    ...
    public function testDatabaseBasedDataStoreWorks()
    {
        ...
        $this->assertTrue(false !== $this->_model->createComment(Helper::getPasteId(), Helper::getPasteId(), Helper::getCommentId(), Helper::getComment(1)), 'store v1 comment');
        ...
        $this->assertTrue(false !== $this->_model->createComment(Helper::getPasteId(), Helper::getPasteId(), Helper::getPasteId(), Helper::getComment(2)), 'store v2 comment');
